							...
							<form action="registerServ" id="reg-form" method="POST">
								...
								<div class="mb-3">
									<label for="Email" class="form-label">Email
										address</label> <input required type="email" name="adminEmail"
					...
					<div class="card-body">
						...
						<div class="mb-3">
								...
								<input type="text" class="form-control"
									id="adminName" aria-describedby="nameHelp">
							</div>
							<div class="mb-3">
							...
							<div class="mb-3 form-check">
								<input type="checkbox" class="form-check-input"
									...
									for="exampleCheck1"><a target="_blank" href="Terms.html" class="link-warning">Agree to terms & conditions</a></label>
							</div>
