		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown"><a
					...
					data-bs-toggle="dropdown" aria-expanded="false"><i
						class="fa-solid fa-building-shield"></i> Admin </a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="addDepts.jsp">Add
								Departments <i class="fa-solid fa-house-user"></i>
						</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="addVisitReas.jsp">Visiting
								Reasons <i class="fa-solid fa-house-circle-check"></i>
						</a></li>
					</ul></li>
				<li class="nav-item dropdown"><a
					class="nav-link active dropdown-toggle" href="#" role="button"
					data-bs-toggle="dropdown" aria-expanded="false"><i
						class="fa fa-person-walking-luggage"></i> Visitors </a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="newVisitor.jsp">New
								Visitor <i class="fa-solid fa-person-circle-exclamation"></i>
						</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="viewVisitors.jsp">View
								Visitors <i class="fa-solid fa-person-circle-check"></i>
						</a></li>
					</ul></li>
				<li class="nav-item dropdown"><a
					class="nav-link active dropdown-toggle" href="#" role="button"
					data-bs-toggle="dropdown" aria-expanded="false"><i
						class="fa-sharp fa-solid fa-briefcase"></i> Employees </a>
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="addEmployee.jsp">New
								Employee <i class="fa-solid fa-champagne-glasses"></i>
						</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item" href="viewEmployees.jsp">View
								Employees <i class="fa-sharp fa-solid fa-circle-info"></i>
						</a></li>
					</ul></li>
			...
			<ul class="navbar-nav mr-right">
					...
					<div class="modal fade" id="profileModal" tabindex="-1"
						...
						<div class="modal-dialog">
							<div class="modal-content"
								...
								<div
									class="modal-header container text-center bg-dark text-white">
				...
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="login.jsp"><i class="fa-solid fa-right-to-bracket"></i> Login</a></li>
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="signup.jsp"><i class="fa-solid fa-user-plus"></i> Sign up</a></li>
